...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        .addField(`Links:`,`- [Youtube Channel](https://www.youtube.com/channel/UC1m8JxBoeuvXnryjCgvgyew)\n- [Discord Server](https://discord.gg/yKnHY2ZG3khttps://discord.gg/ARu4hr6hJw)\n- [DISCORD](JN03#0558)`,true)
        .setTimestamp()
        .setFooter(`Requested by ${interaction.user.username} | GiveawayBot™ v1 By JN`, interaction.user.displayAvatarURL());
          ...
          .setTimestamp()
          .setFooter(`Requested by ${interaction.user.username} | GiveawayBot™ v By Jn`, interaction.user.displayAvatarURL());
